	...
	$("#update").click(function(){
		...
		$("#info tr").each(function(){
			...
			if(oinput.checked == true){
				var skillcode = oinput.value;
				var skillname = this.getElementsByTagName("span")[1].innerHTML;
				var oselect = this.getElementsByTagName("select")[0];
				var levelcode = oselect.options[oselect.selectedIndex].value;
				var levelname = oselect.options[oselect.selectedIndex].text;
				var skill = {"skillcode":skillcode, "skillname":skillname,
