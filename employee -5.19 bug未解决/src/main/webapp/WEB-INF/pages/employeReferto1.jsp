									...
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td	width="205"	>
												<table	border="0" cellspacing="0" cellpadding="0" width="100%"	>
													<tr>
														<td	width="205"	height="27"><span class="menuBranch">&#8226;社員管理</span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="employeRegister.htm" target="_self">社員情報登録</a></span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="employeQuery.htm" target="_self">社員情報検索</a></span></td>
													</tr>
													 <tr>
														<td	height="27"><span class="menuItem">	　<a	href="confirmInfoQuery.html" target="_self">社員情報承認</a></span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuBranch">&#8226;Funnel管理</span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="#" target="_self">XXXX</a></span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="#" target="_self">XXXX</a></span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuBranch">&#8226;プロジェクト管理</span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="#" target="_self">XXXX</a></span></td>
													</tr>
													<tr>
													 ...
													 <tr>
														<td	height="27"><span class="menuBranch">&#8226;稼働管理</span></td>
													</tr> 
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="#" target="_self">XXXX</a></span></td>
													</tr>
													<tr>
													 ...
													 <tr>
														<td	height="27"><span class="menuBranch">&#8226;システム管理</span></td>
													</tr>
													<tr>
														<td	height="27"><span class="menuItem">	　<a	href="#" target="_self">XXXX</a></span></td>
													</tr>
								...
								<form name="form1" method="post" action="">
	                    			...
	                    			<!-- 社員基本情報 -->
					                    ...
					                    <tr>
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.gender eq 男? "男":"女" }</span></td>     
										</tr>                                										
				                      	<tr> 
				                      	...
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.site.name}</span></td>                           
				                      	</tr>
				                      	<tr>
				                      	...
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.billableFlag eq 0? "NonBillable":"Billable"}</span></td> 
				                      	...
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.company.name }</span></td>                                                  
				                     	</tr>                                           	
				                      	<tr> 
				                     	...
				                     	<!-- 日本経歴及びVisa情報 -->                   
				                      	...
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.yearsAtJapan}年</span></td> 
				                      	...
				                      	<tr>
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.passportFlag eq 1? "有":"没有" }</span></td>
				                      	...
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">${emp.visaFlag eq 1? "有":"無 "}</span></td> 
				                      		...
				                      		<td colspan="4">
					              				<table border="0" width="675" cellspacing="1" cellpadding="1">
													<tr class="trHeader">
											  		...
											  		<tr class="trOdd">
														<td nowrap align="center"><span class="txt_normal">${jobs.title.name}</span></td>
