...
public class EmployeeInfo {
	...
	public EmployeeInfo(String eid, String mailAddress, String name, String nameCn, String nameKanji, String nameKana,
			...
			String updUserId, String updTimestamp, JobInfo title, RoleInfo role) {
		super();
		this.eid = eid;
	...
	public JobInfo getTitle() {
		return title;
	}

	public void setTitle(JobInfo title) {
		this.title = title;
	}
	...
	public String toString() {
		return "EmployeeInfo [eid=" + eid + ", mailAddress=" + mailAddress + ", name=" + name + ", nameCn=" + nameCn
				...
				+ ", updUserId=" + updUserId + ", updTimestamp=" + updTimestamp + ", title=" + title + ", role=" + role
				+ "]";
	}
