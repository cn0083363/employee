...
public class JobInfo {
	...
	public JobInfo(String eid, String jobTitleCode, Master title, String jobLevelCode, Master capability,
			Master position, Master confirm, String rejectReason, String insUserid, String insTimestamp,
			String updUserid, String updTimestamp) {
		super();
		this.eid = eid;
	...
	public String toString() {
		return "JobInfo [eid=" + eid + ", jobTitleCode=" + jobTitleCode + ", title=" + title + ", jobLevelCode="
				+ jobLevelCode + ", capability=" + capability + ", position=" + position + ", confirm=" + confirm
				+ ", rejectReason=" + rejectReason + ", insUserid=" + insUserid + ", insTimestamp=" + insTimestamp
