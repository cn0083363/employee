								...
								<form name="form1" method="post" action="">
	                    			...
	                    			<!-- 社員基本情報 -->
										...
										<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">20312554</span></td> 
					                        <td width="134" class="trEven">&nbsp;<span class="txt_normal">メールアドレス</span></td> 
					                        <td class="trOdd"><span class="txt_normal">san.zhang@hp.com</span></td>                              
					                    </tr>                     
				                        <tr><td><br></td></tr>
				                        <tr> 
					                    ...
					                    <tr>
				                      	...
				                      	<tr>
					                        ...
					                        <td class="trOdd"><span class="txt_normal">勤務中</span></td>                         	
				                    	</tr>	
				                      	<tr> 
					                        ...
					                        <td class="trOdd"><span class="txt_normal">普通社員</span></td>                                             
				                      	</tr> 
				                      	<tr> 
