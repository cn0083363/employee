			...
			<tr>
				...
				<table	border="0" width="100%"	height="60"	bgcolor="#003366">
					<tr>
						...
						<td	width="65"><img	src="img/hp_logo.gif" width="47" height="28"> <br><span	class="titleJDDC">JDDC</span> </td>
						<td	rowspan="2">
					...
					<tr>
						...
						<div class="div_workarea_low">
					   	<table border="0" cellspacing="1" cellpadding="0" width="90%" align=center >
							...
							<tr>
								<td	width=15% align=LEFT class="trEven"><font class="txt_normal">場所:</font></td>
								<td	><input type="text" size=80><font class="mustInputStar">*</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<a href="#" onclick="checkAll('base');"><font class="txt_href">Reset</font></a></td>
							</tr>
							<tr>
								<td	width=5% align=center class="trEven"><input	  name="base1" type=checkbox></td>
								<td	width=20% class="trOdd"><font class="txt_normal">Employee ID</font></td>
								<td	width=5% align=center class="trEven"><input name="base2"	type=checkbox></td>
								<td	width=20% class="trOdd"><font class="txt_normal">Last Name</font></td>
								<td	width=5% align=center class="trEven"><input	name="base3" type=checkbox></td>
							...
							<tr>
								...
								<a href="#" onclick="clearAll('base');"><font class="txt_href">Reset</font></a></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<a href="#" onclick="clearAll('visa');"><font class="txt_href">Reset</font></a></td>
							</tr>
							<tr>
								...
								<td	width=5% align=center class="trEven"><input	name="visa32" type=checkbox></td>
							...
							<tr>
								...
								<a href="#" onclick="clearAll('skill');"><font class="txt_href">Reset</font></a></td>
							</tr>
							<tr>
