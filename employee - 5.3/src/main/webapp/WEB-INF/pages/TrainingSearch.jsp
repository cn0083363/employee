					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="1" cellspacing="1">
							...
							<tr>
								...
								<td colspan="3"><input id="startDateFrom" type="text"  name="startDateFrom" size="20"
									class="string" maxlength="8" value=""><input type="image" name="person" class="string" src="img/calendar.gif" onclick="return showCalendar('startDateFrom', 'y/mm/dd');"
onkeydown="javascript:return skip2component(this);"/><span class="txt_normal">&nbsp;～&nbsp;</span><input id="startDateTo"
									type="text"id="startDateTo" size="20" class="string" maxlength="8"
									value=""><input type="image" name="person"src="img/calendar.gif" onclick="return showCalendar('startDateTo', 'y/mm/dd');"
onkeydown="javascript:return skip2component(this);"/></td>
							</tr>
							<tr>
								<td width="25%" class="tdLabel"><span class="txt_normal">完了日付</span></td>
								<td colspan="3"><input id="endDateFrom" type="text" name="T1242" size="20"
									class="string" value=""><input type="image"name="person" src="img/calendar.gif" onclick="return showCalendar('endDateFrom', 'y/mm/dd');"
onkeydown="javascript:return skip2component(this);"/><spanclass="txt_normal">&nbsp;～&nbsp;</span><input id="endDateTo" type="text"
									name="T1242" size="20" maxlength="8 " class="string" value=""><input  type="image" name="person" src="img/calendar.gif" onclick="return showCalendar('endDateTo', 'y/mm/dd');"
...
form.action="${pageContext.request.contextPath }/trainingQueryResult";
form.submit();
}
</script>
</html>
