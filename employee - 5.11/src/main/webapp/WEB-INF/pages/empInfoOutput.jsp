					...
					<tr>
						...
						<div class="div_workarea_low">
						 ...
						 <table	border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
									<input type="button" value="CSV出力" name="close"	class="string" onClick="window.history.back()">&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="button" value="一覧へ" name="close"	 class="string" onClick="window.history.back()"></td>
							</tr>
						</table>
						</form>
						<!-- Work area end here	-->
